//-----------------------------------------------------------------------
// <copyright file="TwoDimensionalStructArray.cs" company="Andy Young">
...
namespace Library
{
    ...
    public abstract class TwoDimensionalStructArray<T> : TwoDimensionalArray<T>
        where T : struct
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoDimensionalStructArray{T}"/> class.
        /// </summary>
        /// <param name="size">The number of rows and columns in the array.</param>
        public TwoDimensionalStructArray(int size)
            : this(size, size)
        {
        }
        ...
        public TwoDimensionalStructArray(int rows, int columns)
            : base(rows, columns)
        {
        }
        ...
        public void InitializeElements(TryGetInitialElementValueDelegate tryGetInitialElementValue)
        {
            ...
            for (int r = 0; r < this.Rows; r++)
            {
                for (int c = 0; c < this.Columns; c++)
                {
                    ...
                    {
                        this.Values[r, c] = initialValue.Value;
                    }
                }
            }
        }
