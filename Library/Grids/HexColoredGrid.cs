//-----------------------------------------------------------------------
// <copyright file="HexColoredGrid.cs" company="Andy Young">
...
namespace Library.Grids
{
    ...
    /// <summary>
    /// Version of <see cref="HexDistanceGrid"/> but distances are portrayed via color.
    /// </summary>
    public class HexColoredGrid : HexDistanceGrid
    {
        private int maximum;

        /// <summary>
        /// Initializes a new instance of the <see cref="HexColoredGrid"/> class.
        /// </summary>
        /// <param name="size">The number of rows and columns in the grid.</param>
        public HexColoredGrid(int size)
            : this(size, size)
        {
        }
        ...
        public HexColoredGrid(int rows, int columns)
            : base(rows, columns)
        {
            if (!this.GetType().IsSubclassOf(typeof(HexColoredGrid)))
            {
        ...
        /// </summary>
        public override Distances<HexCell>? Distances
        {
            get => base.Distances;
            set
            {
        ...
        public override Rgba32 GetCellBackgroundColor(HexCell cell)
        {
